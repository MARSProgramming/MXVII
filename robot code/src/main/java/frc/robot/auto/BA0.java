...
public class BA0 extends SequentialCommandGroup{
    public BA0(DrivetrainSubsystem drivetrainSubsystem, IntakeWheels intakeWheels, IntakePivot intakePivot, ShooterFlywheel shooterFlywheel, ThePivot thePivot, Limelight ll){
        ...
        addCommands(
            ...
            new DriveAtPath(drivetrainSubsystem, BA1, ll, false)
        );
    }
}

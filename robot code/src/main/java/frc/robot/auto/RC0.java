...
public class RC0 extends SequentialCommandGroup{
    public RC0(DrivetrainSubsystem drivetrainSubsystem, IntakeWheels intakeWheels, IntakePivot intakePivot, ShooterFlywheel shooterFlywheel, ThePivot thePivot, Limelight ll, PhotonVision pv){
        ...
        addCommands(
            ...
            new DriveAtPath(drivetrainSubsystem, RC3, ll, false, pv)
        );
    }
}
